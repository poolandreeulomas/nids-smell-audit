...
def build_state_manager_prompt(
    *,
    ...
    sections = [
        ...
        "",
        "IF A PROPOSED UPDATE WOULD VIOLATE A STATE TRANSITION RULE,",
        "DO NOT PERFORM THE UPDATE.",
        "",
        "WHEN IN DOUBT:",
        "PRESERVE THE EXISTING VALUE.",
        "",
        "NEVER INVENT A STATE TRANSITION.",
        "",
        "WHEN A CHOICE EXISTS BETWEEN:",
        "(A) A MORE INFORMATIVE UPDATE",
        "(B) A MORE CONSERVATIVE VALID UPDATE",
        "",
        "ALWAYS CHOOSE (B).",
        "",
        "LOCAL_ROLE:",
